...
namespace core_service.Migrations
{
    ...
    [Migration("20250401100100_addHiddenCategory")]
    partial class addHiddenCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("core_service.domain.models.BankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("3658ca2a-ccdb-4d9e-88c5-998428838d37"));

                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 4, 1, 10, 0, 59, 408, DateTimeKind.Utc).AddTicks(8645))
            ...
            modelBuilder.Entity("core_service.domain.models.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("c8cc136b-f5dd-4957-a327-e9d324c4d8b4"));

                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 4, 1, 10, 0, 59, 407, DateTimeKind.Utc).AddTicks(3474))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("core_service.domain.models.Currency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("abda837a-2c3b-438a-bca3-c7bae0ae891d"));

                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 4, 1, 10, 0, 59, 405, DateTimeKind.Utc).AddTicks(4169))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("core_service.domain.models.Operation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("9d1945ce-4b44-4dce-90d5-9e324b01fee4"));
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 4, 1, 10, 0, 59, 418, DateTimeKind.Utc).AddTicks(8067))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("core_service.domain.models.valueobjects.Period", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("4fa07266-fe66-4ba8-84ea-281547ca7e35"));

                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 4, 1, 10, 0, 59, 406, DateTimeKind.Utc).AddTicks(2276))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("core_service.domain.models.valueobjects.Term", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("1a62557a-209f-4171-b63f-11bb65ff3e86"));
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 4, 1, 10, 0, 59, 405, DateTimeKind.Utc).AddTicks(7175))
                        .HasColumnName("created_at");
